...
//             type="submit"
//             disabled={isSigningIn}
//             className="w-full py-3 cursor-pointer px-4 bg-blue-600 hover:bg-[#6075a5] hover:text-white
//              focus:ring-blue-500 focus:ring-offset-gray-900 text-white font-medium rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:bg-blue-800 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//           >
//             {isSigningIn ? (
//               <>
...
// This component will handle the button's loading state
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Form action is now set to the server action directly */}
        <form action={login} className="space-y-6">
          ...
          {/* Render the new SubmitButton component */}
          <SubmitButton />
        </form>
