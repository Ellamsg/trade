...
//       const userIds = Array.from(new Set(portfolioData.map(item => item.user_id)));
...
//       // Create profiles map
//       const profilesMap = profileData.reduce((acc, profile) => {
...
//                             {profiles[item.user_id]?.full_name?.charAt(0).toUpperCase() || 
//                              profiles[item.user_id]?.email?.charAt(0).toUpperCase() || 
//                              "U"}
//                           </div>
//                           <div>
//                             <div className="font-medium text-white">
//                               {profiles[item.user_id]?.full_name || "Unknown User"}
//                             </div>
//                             <div className="text-xs text-slate-400">
//                               {profiles[item.user_id]?.email || item.user_id.slice(0, 6)}...{item.user_id.slice(-4)}
//                             </div>
//                           </div>
//                         </div>
//                       </td>
