...
//                                   setShowConfirmationModal(true);
//                                 }}
//                                 className={`px-3 py-1 cursor-pointer rounded text-sm font-medium transition-colors flex items-center gap-1 ${
//                                   withdrawal.status
//                                     ? 'bg-green-600 hover:bg-green-700 text-white'
//                                     : 'bg-yellow-600 hover:bg-yellow-700 text-white'
//                                 }`}
//                                 disabled={withdrawal.status}
//                               >
//                                 {withdrawal.status ? (
//                                   <FiCheck className="w-3 h-3" />
//                                 ) : (
...
const AdminTransactionsPage = () => {
  ...
  const startEditingAmount = (id: string, currentAmount: number, type: 'deposit' | 'withdrawal') => {
                          ...
                          <td className="p-4">
                            {editingAmountId === transaction.id ? (
                                ...
                                <div className="flex items-center gap-2">
                                    <p className="text-white font-medium">${transaction.amount.toLocaleString()}</p>
                                    <button
                                        onClick={() => startEditingAmount(transaction.id, transaction.amount, 'deposit')}
                                        className="text-slate-400 hover:text-white transition-colors"
                                    >
                          ...
                          <td className="p-4">
                            {editingAmountId === withdrawal.id ? (
                                ...
                                <div className="flex items-center gap-2">
                                    <p className="text-white font-medium">${withdrawal.amount.toLocaleString()}</p>
                                    <button
                                        onClick={() => startEditingAmount(withdrawal.id, withdrawal.amount, 'withdrawal')}
                                        className="text-slate-400 hover:text-white transition-colors"
                                    >
                                        <FiEdit3 className="w-4 h-4" />
                                    </button>
