...
//     // Subscribe to wallets, wallet_upgrades, and withdrawals changes
...
//           channelRef.current = null;
//           setWaitingForAccount(false);
//           createWallet(data.wallet_type,
//              data.account_number, 
//              data.network as NetworkType,
//               data.token_type as TokenType);
//         }
//       })
//       .subscribe();
//   };
...
//           </div>
//           <div className="bg-slate-800/30 my-6 rounded-xl p-3 md:p-4 border border-slate-700/30">
//             <p className="text-slate-400 text-xs md:text-sm mb minimum-1">Account</p>
//             <p className="text-lg md:text-xl font-bold text-white font-mono">
//               {wallet?.wallet_number || 'N/A'}
//             </p>
//           </div>
